...
- [External user stories (75, US-026–US-100)](queries/ExternalUserStories.md)
...
- [ExternalUserStories](queries/ExternalUserStories.md) — 75 external-facing stories (US-026–US-100): accounts, live UI, settings, MCP/API, agents, persistence, dice audit, export.
