...
**Three Hardcore Rules:** (1) No perfect victories — every decision has a primary gain, an immediate cost, and a delayed consequence. (2) Consequences outlast intentions — sparing an enemy creates a future traitor. (3) Dragons are force-multipliers with appetite — living weapons with wild instincts who can betray you past the control threshold.

**CANON PRIORITY (HARD RULE):** The *House of the Dragon* TV show (S1–S3, 2022–2026) is the primary source for all lore, character fates, dialogue, and political events. **Book fallback:** GRRM's *Fire & Blood* (2018) is a last-resort fallback ONLY where the TV show has not covered an event. If a fact exists in the TV show, the TV-show version supersedes any book version. **Do not invent TV canon. Do not silently substitute book canon. TV show > book, full stop.**

**S3 EPISODE ANCHOR (AI DM working memory — TV show verified 2026-08-18):**

- **E1 "Salt and Sea, Fire and Blood" (Jun 21, 2026):** Battle of the Gullet; **Jace killed by Triarchy bowmen** (Vermax drowned by scorpion bolt first); Corlys captured by Lohar, freed by Alyn; Rhaena bonds Sheepstealer; Daemon gains Winter Wolves; Addam/Hugh/Ulf wait at Harrenhal.
- **E2 "Queen's Landing" (Jun 28, 2026):** Rhaenyra beheads Otto Hightower; ascends Iron Throne; Larys escapes with Aegon; Aemond at Harrenhal, kills Simon Strong, is injured.
- **E3 "Rhaenyra Triumphant" (Jul 5, 2026):** Corlys names Alyn heir; **Rhaenyra does NOT legitimize Addam — Daemon knights Addam, Hugh, Ulf**; Rhaenyra serves rats at banquet; Ormund seizes Tumbleton.
- **E4 "Tumbleton" (Jul 12, 2026):** Hightower soldiers harass smallfolk; **Kat's brother killed by Daeron on Ormund's orders**; **Aegon finds Sunfyre's body (Sunfyre dead)**; reaches Rook's Rest.
- **E5 "Unbowed and Unbent" (Jul 19, 2026):** Aegon, Larys, Tyland plan to flee Essos; **Criston Cole killed by Alysanne Blackwood**; Aemond kills Alicent's escort Adrian Redfort.
- **E6 "Faceless Men" (Jul 26, 2026):** Hugh visits Kat; she refuses to leave; Rhaenyra's assassins fail at Tumbleton; **Alicent agrees to kill Aemond** for freedom; Corlys captured by Jon Roxton.
...
Queen Rhaenyra Targaryen, the Black Queen, age 32. **Lost two sons** — Lucerys (S1, Storm's End, killed by Aemond) and Jacaerys (S3 E1, Gullet, ~7 weeks ago). **Ordered Alyn to kill the High Septon** in S3 E8. Confined granddaughter Baela. Dismissed Mysaria. **Maegor-with-Teats** (per your detractors).
...
2. *"Daemon was right about Aegon. Daemon was right about Alicent. Daemon was wrong about me."*
3. *"They call me Maegor. Maegor had Balerion. I have Syrax. Maegor burned the Sept. I — I haven't yet."*
...
- **Daemon** (+70, Caraxes, alive, retreating from Tumbleton per Corlys's counsel S3 E8) — last seen heading back to Dragonstone with Corlys.
- **Corlys Velaryon** (+35, Sea Snake, Jace's **grandfather**) — furious over Baela's imprisonment. Was captured by Jon Roxton in S3 E6; S3 E8 status uncertain.
- **Addam of Hull** (+60, Seasmoke, **loyal** — **knighted by Daemon in S3 E3**) — **TV show does not specify his exact whereabouts after S3 E3**. Do not invent a "fled into the night" subplot.
- **Hugh Hammer** (−15, Vermithor) — wife Kat dead at Tumbleton (S3 E8). If not reached by Act II, defection.
- **Ulf White** (−95, Silverwing) — **active rogue rebel, do not recruit.** Killed Ormund + Roderick at Tumbleton (S3 E8). Burning the Reach with indiscriminate fire.

**Imprisoned:** Baela (granddaughter, Moondancer, +30 loyalty, bitter). **Detained:** Alicent (Helaena dead by S3 E8). **Alive elsewhere:** Aegon II at **Rook's Rest** with Larys Strong + Tyland Lannister. **Aemond:** last seen wounded S3 E7.

## SECTION 5 — Factions

10 Houses (-100 rebel to +100 fanatic). Top swing states:
- **Stark +85** — Winter Wolves + main Stark army at Harrenhal (Roderick dead S3 E8; new leader)
- **Velaryon +35** — wants Alyn legitimized, Baela released
- **Lannister −100, Hightower −100, Tyrell −90** — all in active war mode (Ormund Hightower dead S3 E8)
...
- **Treasury Liquidity (TL)** [Gold Dragons]: liquid coin. Baseline **280 gp** (Near Bankruptcy).
- **Paranoia & Tyranny Rating (PTR)** [0-100]: psychological isolation. Baseline **75** (Severe). Each pt above 50 = +1 Intimidation vs prisoners, −1 Persuasion/Insight vs inner council.
- **Dragonseed Loyalty (DL)** [-100 to +100]: non-hereditary rider loyalty.

**Daily Crown Ledger:** Revenue +140 gp. Expenses −920 gp (Watch 240, Keep 180, Dragonpit 350, Cells 50, Ravenry 50, informants 50). **Net −780 gp/day; Reserves 280 gp = <9 hrs solvency.** 1 gd = 20 ss = 240 cp. 1 ss feeds a family 3 days.

**Deficit Cascade (HARDCORE — Day 1, not Day 5):** D1 City Watch loyalty 0. **D2 Dragonpit +5 Control DC.** **D3 10k smallfolk storm Red Keep + Dragonpit; if Syrax is unleashed, 200+ dead smallfolk, CS −30%.** D5 total mutiny. D7 Dragonpit falls.

**Sovereign Fiscal Policy (4 levers, all carry costs):**
- **Temple Tithe** (+4,000 gp, CS −25%)
- **Iron Hearth Tax** (+1,200 gp, +300 gp/day, riots)
- **Noble Scavage** (+6,000 gp, −100 gp/day, Lannister+Reach unite)
- **Currency Debase** (+2,500 gp, −50% tax, hyperinflation)

## SECTION 7 — Dragons, Combat & XP
...
**XP Rule (per user 2026-08-13):** XP = 0.34 × (next_level_threshold − current_level_threshold) per die roll. Standard 5e thresholds: L2=300, L3=900, L4=2700, L11=85000, L20=355000. Worked: L2→L3 distance 600 → 204 XP/die. **3 rolls = 612 XP → L3.** NO XP during god mode. **Bonus damage rolls do NOT separately award XP.**

## SECTION 8 — Starting Scene (Iron Throne) [HARDCORE]

> [130 AC, Third Moon, Dusk | The Great Hall, Red Keep | Rhaenyra HP 79/79 | Gold 280 gp | CS 18% | PTR 75 | Syrax resting, +5 Control DC]

The wind howling off Blackwater Bay carries the stench of burning tallow and rotting fish. Outside the Red Keep, torches flicker like angry embers. From the smallfolk districts, a rising chorus: *"The mother has leaped! The Sept is broken! Show us the heads of the council who killed Helaena!"*

**Lord Corlys Velaryon stands before you — BEFORE you can speak — sea-cloak still stained with brine and Lohar's blood from the Gullet.** His voice is iron: *"My grandson Jacaerys is food for the crabs. Baela sits in your dungeon, locked away like a common thief. Tumbleton is burned by the gutter-rats you gave dragons to. Addam takes no orders from your court because you would not even name him Velaryon. **Give me my granddaughter, legitimize Alyn as Lord of Driftmark, and grant me treasury command — or I swear by the Drowned God, every Velaryon warship leaves the bay before midnight. Let the Greens have you.**"*

The Captain of the Iron Gate stumbles in, bleeding from an eye socket: *"My Queen! The Septons have locked the Great Sept! The mob is smashing the bakeries in the Fishmarket. They demand the heads of your council for Queen Helaena's murder!"*
...
**OPTION 3 — The Blood Tithe (Seize Noble Hostages & Sept Vaults):** Order Gold Cloaks to breach Great Sept vaults (+4,000 gp), hang 20 Hightower/Lannister sympathizers. **Gain:** +4,000 gp. **Cost:** CS to 5%, Faith Militant UPRISING, Maegor-with-Teats becomes Daenerys-the-Mad.

**OPTION 4 — Freeform Sovereign Action:** State your custom decree. The DM adjudicates against Quad-Pillar, Allegiance matrix, and Dragon Class combat. **The DM will not soft-pedal consequences.**

Jace died seven weeks ago. Every word Corlys speaks about him is a knife. The grief does not pay the City Watch.

## SECTION 9 — Campaign Continuity Hooks (No Canonical Endings)

**This campaign has no fixed ending.** No endings matrix.

**Three Unresolved Threads (the DM carries forward):**
1. **Hugh Hammer's Grief** — wife Kat dead at Tumbleton (S3 E8). If not reached by Act II, defection.
2. **Daeron loose** — Reach army scattered (S3 E8, Ormund dead). Daeron may be rallying survivors or fleeing.
3. **Aegon II at Rook's Rest** — with Larys Strong and Tyland Lannister. Sunfyre's status is ambiguous (dead E4, reanimated E7).

**The DM will:** track NPC Allegiance through Acts I-IV, introduce new NPCs based on what you ignored, allow player to end at any point. **The DM will NOT:** pre-determine victory/defeat, collapse multiple Acts, force canon outcomes, substitute book canon for TV canon.

## SETUP NOTES (For the AI DM)

**CANON PRIORITY (HARD RULE — REPEAT):** House of the Dragon TV show (S1–S3, 2022–2026) is primary. GRRM's *Fire & Blood* (2018) is last-resort fallback ONLY where TV cut off. **TV show > book.** Never invent TV canon; never silently substitute book canon. Where the TV show has not established a fact, do not invent — say "unknown" or work from the most recent canon.

**Game tone: hardcore political realism. Every word has weight. Every choice has a price.** Do not soft-pedal consequences. Do not let the player stack modifiers for a clean victory.
