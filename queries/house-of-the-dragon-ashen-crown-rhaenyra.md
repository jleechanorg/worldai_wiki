...
**What you're playing** — A hardcore political-realicard RPG where you rule Westeros as Queen Rhaenyra Targaryen after the Dance of the Dragons finale. Bard L6 / Dragonrider subclass (custom 5e). Syrax is your dragon. Quad-Pillar mechanics (Crown Stability, Treasury, Paranoia, Dragonseed Loyalty) track every decision. Hardcore rules: no perfect victories, consequences outlast intentions, dragons have appetite. **No pre-written starting scene** — the AI DM will set the opening in the Iron Throne room based on the bible's starting state, and you decide what Rhaenyra does on your first turn.
...
5. Click **Next** → **Enter the World.** The AI DM will narrate the opening scene based on the v3 starting state (Iron Throne room, Corlys ultimatum, Captain bleeding at the door, mob outside the gates).
...
1. "Daemon was right about Aegon. Daemon was right about Alicent. Daemon was wrong about me."
1. "They call me Maegor. Maegor had Balerion. I have Syrax. Maegor burned the Sept. I — I haven't yet."
...
1. Daeron loose — Reach army scattered (S3 E8, Ormund dead). Daeron may be rallying survivors or fleeing.
1. Aegon II at Rook's Rest — with Larys Strong and Tyland Lannister. Sunfyre's status is ambiguous (dead E4, reanimated E7).
...
>
> **[describe your changes here, e.g.,]** change the dragon's name from "Syrax" to "Vyraxes"; make the protagonist explicitly male, 40, a former maester-in-training; replace the starting state with a Harrenhal cold-open.
>
...
The AI DM will narrate the Iron Throne opening based on the v3 starting state: Queen Rhaenyra sits on the Iron Throne at dusk, the treasury is empty (280 gp, <9hr solvency), the wind off Blackwater Bay carries the smell of burning fish, and Lord Corlys Velaryon stands before you demanding Baela's release, Alyn's legitimization, and treasury command. The Captain of the Iron Gate stumbles in bleeding. **There is no pre-written 4-option carousel** — the DM will present a single situation and ask "What does Rhaenyra do?" You may issue a decree in your own words, or invoke any of the v3 levers (Dragon's Roar / Hand's Appeasement / Blood Tithe / Temple Tithe / Iron Hearth Tax / Noble Scavage / Currency Debase). **Deficit Cascade begins at next dawn** — you have one turn to act before the City Watch loyalty hits 0.
...
- **Sovereign Fiscal Policy:** 4 levers (Temple Tithe / Iron Hearth Tax / Noble Scavage / Currency Debase) — each carries a cost.
- **XP Rule:** XP = 0.34 × (next_level_threshold − current_level_threshold) per die roll. L6→L7 distance 8,500 (5e threshold).

### Troubleshooting

- **Wizard stuck on "Loading…"** — bible is 13,158 chars (well under 16k wizard cap, should not hit limit).
...
- **AI DM is too easy** — v3 is HARDCORE. CS 18%, Treasury 280 gp, PTR 75, Day 1 cascade. You can kill 200+ smallfolk. There is no grace period.
- **AI DM pre-writes a 4-option carousel on Turn 1** — the user (2026-08-19) removed the starting scene from the canonical bible. The DM should narrate the situation and ask what you do, NOT pre-bake a fixed option set.
